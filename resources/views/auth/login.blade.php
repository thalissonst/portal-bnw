...
<head>
    ...
    <title>Acessar - Portal BNW</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bem vindo ao Portal BNW</h1>
                                    </div>
                                    <form action="{{ route('login.auth') }}" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            <input name="email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="E-mail" required>
                                        </div>
                                        <div class="form-group">
                                            <input name="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Senha" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-user">Acessar</button>
                                    </form>
                                    <hr>
                                </div>
                            </div>
